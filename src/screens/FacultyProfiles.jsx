...
function FacultyProfilesTableEntry({ onEdit, onView, onDelete }) {
  return (
    <div className="main__content__table__list">
      ...
      <div className="main__content__table__list__entry">4 years</div>
      <div className="main__content__table__list__entry">BS CS</div>
      <div className="main__content__table__list__entry">
        <img
...
export default function FacultyProfiles({ onAdd, onEdit, onView, onDelete }) {
  return (
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">Faculty Profiles</div>
      ...
      <div className="main__content">
        <div className="main__content__table">
          <div className="main__content__table__header">
            ...
            <TableHeaderEntry title="Experience" />
            <TableHeaderEntry title="Qualification" />
            <TableHeaderEntry title="Image" />
          </div>
          <FacultyProfilesTableEntry onEdit={onEdit} onDelete={onDelete} />
          <FacultyProfilesTableEntry onEdit={onEdit} onDelete={onDelete} />
          <FacultyProfilesTableEntry onEdit={onEdit} onDelete={onDelete} />
          <FacultyProfilesTableEntry onEdit={onEdit} onDelete={onDelete} />
          <FacultyProfilesTableEntry onEdit={onEdit} onDelete={onDelete} />
