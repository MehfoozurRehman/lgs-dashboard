...
function AlumniRegistrationTableEntry({ onEdit, onView, onDelete }) {
  return (
    <div className="main__content__table__list">
      ...
      <div className="main__content__table__list__entry">Fahad</div>
    ...
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">Alumni Registration</div>
      ...
      <div className="main__content">
        <div className="main__content__table">
          <div className="main__content__table__header">
            ...
            <TableHeaderEntry title="Father Name" />
            <TableHeaderEntry title="Email" />
            <TableHeaderEntry title="Phone No" />
            <TableHeaderEntry title="Session" />
            <TableHeaderEntry title="Education" />
            <TableHeaderEntry title="Name Of University (Graduation)" />
            <TableHeaderEntry title="Name Of University (Post-Graduation)" />
            <TableHeaderEntry title="Profession" />
            <TableHeaderEntry title="Current Business Address" />
            <TableHeaderEntry title="Where Did Life Take You After LGS?" />
            <TableHeaderEntry title="Fondest Memory Of LGS?" />
          </div>
          <AlumniRegistrationTableEntry onEdit={onEdit} onDelete={onDelete} />
          <AlumniRegistrationTableEntry onEdit={onEdit} onDelete={onDelete} />
          <AlumniRegistrationTableEntry onEdit={onEdit} onDelete={onDelete} />
          <AlumniRegistrationTableEntry onEdit={onEdit} onDelete={onDelete} />
          <AlumniRegistrationTableEntry onEdit={onEdit} onDelete={onDelete} />
