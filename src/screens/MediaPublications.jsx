...
function MediaPublicationsTableEntry({ onEdit, onView, onDelete }) {
  return (
...
export default function MediaPublications({ onAdd, onEdit, onView, onDelete }) {
  const navigate = useNavigate();
  return (
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">Media & Publications</div>
      ...
      <div className="main__content">
        <div className="main__content__table">
          ...
          <MediaPublicationsTableEntry
            onView={() => {
              navigate("/dashboard/campus_life/publications/details");
            }}
            onEdit={onEdit}
            onDelete={onDelete}
          />
          <MediaPublicationsTableEntry onEdit={onEdit} onDelete={onDelete} />
          <MediaPublicationsTableEntry onEdit={onEdit} onDelete={onDelete} />
          <MediaPublicationsTableEntry onEdit={onEdit} onDelete={onDelete} />
          <MediaPublicationsTableEntry onEdit={onEdit} onDelete={onDelete} />
          <MediaPublicationsTableEntry onEdit={onEdit} onDelete={onDelete} />
