...
function NoticeBoardTableEntry({ onEdit, onView, onDelete }) {
  return (
...
export default function NoticeBoard({ onAdd, onEdit, onView, onDelete }) {
  return (
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">Notice Board</div>
      ...
      <div className="main__content">
        <div className="main__content__table">
          <div className="main__content__table__header">
            ...
            <TableHeaderEntry title="Posting" />
            <TableHeaderEntry title="Designation" />
          </div>
          <NoticeBoardTableEntry onEdit={onEdit} onDelete={onDelete} />
          <NoticeBoardTableEntry onEdit={onEdit} onDelete={onDelete} />
          <NoticeBoardTableEntry onEdit={onEdit} onDelete={onDelete} />
          <NoticeBoardTableEntry onEdit={onEdit} onDelete={onDelete} />
          <NoticeBoardTableEntry onEdit={onEdit} onDelete={onDelete} />
