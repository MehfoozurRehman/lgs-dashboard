...
function LearningDevelopmentProgramsTableEntry({ onEdit, onView, onDelete }) {
  return (
    <div className="main__content__table__list">
      ...
      <div className="main__content__table__list__entry">08:00 PM</div>
      <div className="main__content__table__list__entry">Faisalabad</div>
      <div className="main__content__table__list__entry">Asad</div>
...
export default function LearningDevelopmentPrograms({
  onAdd,
  onEdit,
  onView,
  onDelete,
      ...
      <div className="main__content">
        <div className="main__content__table">
          <div className="main__content__table__header">
            ...
            <TableHeaderEntry title="Time" />
            <TableHeaderEntry title="Venue" />
            <TableHeaderEntry title="Speaker" />
            <TableHeaderEntry title="Registration" />
            <TableHeaderEntry title="Is Featured" />
          </div>
          <LearningDevelopmentProgramsTableEntry
            onEdit={onEdit}
            onDelete={onDelete}
          />
          <LearningDevelopmentProgramsTableEntry
