...
function AcademicCalendarTableEntry({ onEdit, onView, onDelete }) {
  return (
    <div className="main__content__table__list">
      ...
      <div className="main__content__table__list__entry">Winter</div>
      <div className="main__content__table__list__entry">20/12/2022</div>
      <div className="main__content__table__list__entry">
...
export default function AcademicCalendar({ onAdd, onEdit, onView, onDelete }) {
  return (
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">Academic Calendar</div>
      ...
      <div className="main__content">
        <div className="main__content__table">
          <div className="main__content__table__header">
            ...
            <TableHeaderEntry title="Break Type" />
            <TableHeaderEntry title="Date Range" />
            <TableHeaderEntry title="PDF" />
          </div>
          <AcademicCalendarTableEntry onEdit={onEdit} onDelete={onDelete} />
          <AcademicCalendarTableEntry onEdit={onEdit} onDelete={onDelete} />
          <AcademicCalendarTableEntry onEdit={onEdit} onDelete={onDelete} />
          <AcademicCalendarTableEntry onEdit={onEdit} onDelete={onDelete} />
          <AcademicCalendarTableEntry onEdit={onEdit} onDelete={onDelete} />
