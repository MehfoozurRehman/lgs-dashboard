...
function UniversityPlacementTableEntry({ onEdit, onView, onDelete }) {
  return (
    ...
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">University Placement</div>
      ...
      <div className="main__content">
        <div className="main__content__table">
          ...
          <UniversityPlacementTableEntry onEdit={onEdit} onDelete={onDelete} />
          <UniversityPlacementTableEntry onEdit={onEdit} onDelete={onDelete} />
          <UniversityPlacementTableEntry onEdit={onEdit} onDelete={onDelete} />
          <UniversityPlacementTableEntry onEdit={onEdit} onDelete={onDelete} />
          <UniversityPlacementTableEntry onEdit={onEdit} onDelete={onDelete} />
