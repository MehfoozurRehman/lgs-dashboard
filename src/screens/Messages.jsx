...
function MessagesTableEntry({ onEdit, onView, onDelete }) {
  return (
    <div className="main__content__table__list">
      ...
      <div className="main__content__table__list__entry">Principal</div>
      <div className="main__content__table__list__entry">
...
export default function Messages({ onAdd, onEdit, onView, onDelete }) {
  return (
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">Messages</div>
      ...
      <div className="main__content">
        <div className="main__content__table">
          ...
          <MessagesTableEntry onEdit={onEdit} onDelete={onDelete} />
          <MessagesTableEntry onEdit={onEdit} onDelete={onDelete} />
          <MessagesTableEntry onEdit={onEdit} onDelete={onDelete} />
          <MessagesTableEntry onEdit={onEdit} onDelete={onDelete} />
          <MessagesTableEntry onEdit={onEdit} onDelete={onDelete} />
