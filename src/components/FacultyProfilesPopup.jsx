...
export default function FacultyProfilesPopup({ onClose, onSubmit, isEdit }) {
  return (
    <div className="popup">
      <form className="popup__form">
        ...
        <div className="popup__form__heading">
          {isEdit ? "Edit" : "Add"} Faculty Profile
        </div>
        <div className="popup__form__row">
          <div style={{ flex: 1, marginRight: "1.5em" }}>
            ...
            <div className="popup__form__row">
              <div className="popup__form__input">
                <div className="popup__form__input__label">Subject</div>
                <Select
                  options={[
        ...
        <div className="popup__form__row">
          <div className="popup__form__input">
            <div className="popup__form__input__label">Experiance</div>
            <TextArea />
            <div className="popup__form__input__error"></div>
          </div>
        </div>
